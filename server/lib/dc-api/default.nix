...
, ghc-heap-view, graphql-parser, hashable, hasura-extras, hspec, hspec-core
...
, witch, xml-conduit, xml-lens, yaml, zlib
}:
mkDerivation {
  pname = "dc-api";
  version = "1.0.0";
  ...
  libraryHaskellDepends = [
    ...
    extra ghc-heap-view graphql-parser hashable hasura-extras http-media
